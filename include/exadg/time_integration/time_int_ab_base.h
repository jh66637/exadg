...
#ifndef INCLUDE_EXADG_TIME_INTEGRATION_TIME_INT_AB_BASE_H_
#define INCLUDE_EXADG_TIME_INTEGRATION_TIME_INT_AB_BASE_H_
...
namespace ExaDG
{
class TimeIntABBase : public TimeIntMultistepBase
{
public:
  TimeIntABBase(double const        start_time_,
...
protected:
  ...
  {
    ab.update(this->time_step_number, adaptive_time_stepping, time_steps);
    bdf.update(this->time_step_number, adaptive_time_stepping, time_steps);
  }
...
#endif /* INCLUDE_EXADG_TIME_INTEGRATION_TIME_INT_AB_BASE_H_ */
